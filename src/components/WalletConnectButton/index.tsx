            ...
            >
                <div className={styles.modalDiv}>
                    ...
                    <div className={styles.modalwalletDiv}>
                        <div
                            className={styles.modalMetamaskDiv}
                            onClick={connect}
                        >
                            <Image src="/Metamask.png" width={48} height={48} />
                        ...
                        <div className={styles.modalCoinBaseDiv}>
                            <Image src="/Coinbase.png" width={48} height={48} />
            ...
            {!address ? (
                <div className={styles.walletDiv}>
                    ...
                    <div onClick={showModal} className={styles.walletIconDiv}>
                        <Image src="/Wallet.png" width={40.96} height={43} />
                    </div>
                </div>
            ) : (
                <>
                    ...
                    <div className={styles.walletTotalDiv}>
                        ...
                        {dropdownOpen == true && (
                            <div className={styles.walletDropdownMen}>
                                <div
                                    className={styles.walletProfileDiv}
                                    onClick={() => {
                                        router.push("/profile");
                                    }}
                                >
                                    <img
                                        ...
                                        src="/profile.png"
                                    />
                                    <p className={styles.walletSettingP}>
                                        Profile
                                    </p>
                                </div>
                                <div
                                    className={styles.walletSettingsDiv}
                                    onClick={() => {
                                ...
                                <div
                                    className={styles.disconnectPanel}
                                    onClick={hideButton}
                                >
                                    <img
                                        ...
                                        className={styles.walletSettingIcon}
                                    />
                                    <p className={styles.disconnectP}>
                                        Disconnect
                                    </p>
                                    <br></br>
                                </div>
